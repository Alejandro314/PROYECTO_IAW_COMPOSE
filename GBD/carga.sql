...
flush privileges;
CREATE USER 'condoriano'@'localhost' IDENTIFIED BY '890iopklñ';
CREATE USER 'condoriano'@'127.0.0.1' IDENTIFIED BY '890iopklñ';
CREATE USER 'condoriano'@'%' IDENTIFIED BY '890iopklñ';
CREATE USER 'condoriano'@'::1' IDENTIFIED BY '890iopklñ';
GRANT select,insert,update,delete ON alebuntu.* TO 'condoriano'@'localhost' IDENTIFIED BY "890iopklñ";
GRANT select,insert,update,delete ON alebuntu.* TO 'condoriano'@'%' IDENTIFIED BY "890iopklñ";
GRANT select,insert,update,delete ON alebuntu.* TO 'condoriano'@'127.0.0.1' IDENTIFIED BY "890iopklñ";
GRANT select,insert,update,delete ON alebuntu.* TO 'condoriano'@'::1' IDENTIFIED BY "890iopklñ";
flush privileges;
